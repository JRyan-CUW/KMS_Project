...
export class SignInComponent implements OnInit {
    ...
    submitAndAddAnother() {
        ...
        tempFund.goalAmount = Number(this.fundSignUpGoal);
        ...
        tempFund.picLoc = id;
        this.task = this.ref.put(this.fileFund);
        tempFund.value = tempFund.currentAmount/tempFund.goalAmount * 100;
        tempFund.picFullLoc = 'https://firebasestorage.googleapis.com/v0/b/klug-management-system.appspot.com/o/' + tempFund.picLoc +'?alt=media&token=97d616b3-b72d-4657-9cc0-96d36cb8ce56'
    ...
    signUpSchool() {
        ...
        this.schoolToSignUp.picFullLoc = 'https://firebasestorage.googleapis.com/v0/b/klug-management-system.appspot.com/o/' + this.schoolToSignUp.picLoc +'?alt=media&token=97d616b3-b72d-4657-9cc0-96d36cb8ce56';
        ...
        this.delay(1000).then(any=>{
            ...
            this.firestoreService.createSchools(JSON.parse(JSON.stringify(this.schoolToSignUp)));

            this.authService.signIn(this.schoolSignUpEmail, this.schoolSignUpPassword);
       }); 
